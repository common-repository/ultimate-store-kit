...
if ( ! class_exists( 'Insights_SDK' ) ) {
	...
	class Insights_SDK {
		...
		public function data_prepare( $params ) {
			 ...
			 */
			$custom_data = array(
				'active_modules' => get_option( 'ultimate_store_kit_active_modules', false ),
				'third_party'    => get_option( 'ultimate_store_kit_edd_modules', false ),
				'extend'         => get_option( 'ultimate_store_kit_general_modules', false ),
			);
