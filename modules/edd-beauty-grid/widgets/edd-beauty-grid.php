...
class EDD_Beauty_Grid extends Module_Base {
    ...
    public function get_style_depends() {
        if ($this->usk_is_edit_mode()) {
            ...
            return ['usk-font', 'usk-edd-beauty-grid'];
        }
    }
    ...
    public function render_header() {
        ...
        $this->add_render_attribute('usk-edd-beauty-grid', 'class', ['usk-edd-beauty-grid'], true);
...
?>
        ...
        ?>
            <div <?php $this->print_render_attribute_string('edd-beauty-grids-wrapper'); ?>>
                <?php
